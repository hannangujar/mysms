class StaffsController < ApplicationController
  ...
  private
    ...
    def staff_params
      params.require(:staff).permit(:user_id, :contact_id, :address_id, :staff_type, :salary, :identity_card_number, :father_name, :place_of_birth, :date_of_hiring, :year_of_service, :meta)
    end
end
