...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference("Parent.count") do
      post parents_url, params: { parent: { address_id: @parent.address_id, contact_id: @parent.contact_id, meta: @parent.meta, ocupation: @parent.ocupation, user_id: @parent.user_id } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { address_id: @parent.address_id, contact_id: @parent.contact_id, meta: @parent.meta, ocupation: @parent.ocupation, user_id: @parent.user_id } }
